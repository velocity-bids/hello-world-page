...
import { Loader2, ArrowLeft, CheckCircle, XCircle, Clock, Gauge, Calendar, MapPin } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
    ...
    <BasePage>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-2xl font-bold">${vehicle.current_bid.toLocaleString()}</p>
                  <p className="text-sm text-muted-foreground">{vehicle.bid_count} bids</p>
                </div>
                <Separator />
                {vehicle.reserve_price && (
                  <div>
                    <p className="text-sm text-muted-foreground">Reserve Price</p>
                    <p className="text-lg font-semibold">${vehicle.reserve_price.toLocaleString()}</p>
                  </div>
                )}
                <div>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {dialogAction === 'approve' ? 'Approve Listing' : 'Decline Listing'}
            </DialogTitle>
            <DialogDescription>
